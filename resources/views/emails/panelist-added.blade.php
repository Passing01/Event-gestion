...
<head>
    ...
    <title>Nouvel événement ajouté - Event Q&A</title>
    <style>
        ...
        .event-box { background: #f1f5f9; border-radius: 12px; padding: 24px; margin: 24px 0; border: 1px solid #e2e8f0; }
        .event-item { margin-bottom: 12px; border-bottom: 1px dashed #cbd5e1; padding-bottom: 12px; }
...
<body>
    <div class="wrapper">
        <table class="main">
            ...
            <tr>
                <td class="content">
                    <h1>Nouvel événement attribué !</h1>
                    <p>Bonjour <strong>{{ $userName }}</strong>,</p>
                    <p>Vous avez été ajouté en tant que panéliste pour un nouvel événement sur <strong>{{ $appName }}</strong>.</p>
                    
                    <p>Voici les détails de cet événement :</p>
                    
                    <div class="event-box">
                        <div class="event-item">
                            <span style="color:#64748b; display: block; font-size: 14px; margin-bottom: 4px;">Événement :</span>
                            <span style="font-weight:700; color:#0f172a; font-size: 17px;">{{ $eventName }}</span>
                        </div>
                        <div class="event-item">
                            <span style="color:#64748b; display: block; font-size: 14px; margin-bottom: 4px;">Thème / Description :</span>
                            <span style="font-weight:500; color:#334155;">{{ $eventTheme }}</span>
                        </div>
                    </div>

                    <p>Comme vous possédez déjà un compte panéliste, vous pouvez vous connecter immédiatement en utilisant vos identifiants habituels.</p>
