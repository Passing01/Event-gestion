...
<head>
    ...
    <title>Salle d'attente : {{ $event->name }}</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Outfit:wght@400;600;800&display=swap">
    <style>
        :root {
            --brand: {{ $event->user->brand_color ?? '#6366f1' }};
            --brand-soft: {{ ($event->user->brand_color ?? '#6366f1') . '15' }};
            --bg: #0f172a;
            --text: #f8fafc;
        }
...
<body>
    <div class="container">
        ...
        <div class="event-badge">SALLE D'ATTENTE PUBLIQUE</div>
        <h1>{{ $event->name }}</h1>
        <p>L'événement n'a pas encore démarré. Merci de patienter, nous commençons bientôt !</p>
        ...
        <div class="refresh-hint">L'accès sera automatiquement ouvert à l'heure prévue.</div>
    </div>
