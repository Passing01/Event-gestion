                            ...
                            <div class="sidebar-header">
                                ...
                                <button class="sidebar-toggle" onclick="toggleSidebar()" aria-label="Toggle Sidebar">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="2" stroke="currentColor" class="chevron-icon" id="chevron-icon">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.subscriptions.index') }}"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="2" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75-10.5h16.5a1.5 1.5 0 011.5 1.5v10.5a1.5 1.5 0 01-1.5 1.5H3.75A1.5 1.5 0 012.25 18V4.5a1.5 1.5 0 011.5-1.5z" />
                                                </svg>
                                ...
                                <div class="topbar-search">
                                    <label>
                                        ...
                                        <input type="search" id="topbar-search-input"
                                            placeholder="Rechercher pièces, appareils..." aria-label="Recherche">
                                    </label>
                                </div>
                                ...
                                <div class="topbar-actions">
                                    ...
                                    <div class="dropdown" id="notif-dropdown">
                                        <button class="topbar-btn" id="notif-btn" aria-label="Notifications"
                                            ...
                                            <span
                                                style="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);">Ouvrir
                                        ...
                                        <div class="dropdown-content">
                                            ...
                                            <div style="padding:0 0.5rem 0.5rem;">
                                                ...
                                                <div class="color-picker-row" id="color-picker-row">
                                                    <button class="color-swatch active" data-brand="purple"
                                                        aria-label="Violet" style="background:#7c3aed;"
                                                        onclick="setBrand('purple',this)"></button>
                                                    <button class="color-swatch" data-brand="blue" aria-label="Bleu"
                                                        style="background:#2563eb;"
                                                        onclick="setBrand('blue',this)"></button>
                                                    <button class="color-swatch" data-brand="teal"
                                                        aria-label="Turquoise" style="background:#0d9488;"
                                                        onclick="setBrand('teal',this)"></button>
                                                    <button class="color-swatch" data-brand="orange" aria-label="Orange"
                                                        style="background:#ea580c;"
                                                        onclick="setBrand('orange',this)"></button>
                                                    <button class="color-swatch" data-brand="pink" aria-label="Rose"
                                                        style="background:#db2777;"
                                                        onclick="setBrand('pink',this)"></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dropdown" id="user-dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            ...
                                            <div class="dropdown-sep"></div>
                                            <a href="{{ route('dashboard.profile') }}" class="dropdown-item">Mon
                                                Profil</a>
                                            <div class="dropdown-sep"></div>
                                            <form action="{{ route('auth.logout') }}" method="POST">
                                                @csrf
                                                <button type="submit" class="dropdown-item destructive"
                                                    style="width: 100%; text-align: left; background: none; border: none; cursor: pointer; font-family: inherit; font-size: inherit; padding: 0.5rem 1rem;">Déconnexion</button>
                                            </form>
                                        </div>
                                    </div>
